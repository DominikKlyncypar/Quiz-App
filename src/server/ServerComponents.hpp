 ...
 * components in oatpp::base::Environment.
 ...
 public:
  ...
  ([] {
    return oatpp::network::tcp::server::ConnectionProvider::createShared(
        {"0.0.0.0", 8400, oatpp::network::Address::IP_4});
  }());
  ...
  /**
   * Create ConnectionHandler component which uses the Router component to route
   * requests.
   */
